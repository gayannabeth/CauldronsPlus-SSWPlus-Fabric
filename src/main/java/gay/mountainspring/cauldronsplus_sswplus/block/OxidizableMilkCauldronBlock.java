...
public class OxidizableMilkCauldronBlock extends MilkCauldronBlock implements Oxidizable {
	public static final MapCodec<OxidizableMilkCauldronBlock> CODEC = RecordCodecBuilder.mapCodec(
			...
			.apply(instance, OxidizableMilkCauldronBlock::new));
	
	private final Oxidizable.OxidationLevel oxidationLevel;
	
	@Override
	protected MapCodec<OxidizableMilkCauldronBlock> getCodec() {
		return CODEC;
	}
	
	public OxidizableMilkCauldronBlock(Oxidizable.OxidationLevel oxidationLevel, CauldronGroup group, Settings settings) {
