...
public class OxidizableSlimeCauldronBlock extends SlimeCauldronBlock implements Oxidizable {
	public static final MapCodec<OxidizableSlimeCauldronBlock> CODEC = RecordCodecBuilder.mapCodec(
			...
			.apply(instance, OxidizableSlimeCauldronBlock::new));
	
	private final Oxidizable.OxidationLevel oxidationLevel;
	
	@Override
	protected MapCodec<OxidizableSlimeCauldronBlock> getCodec() {
		return CODEC;
	}
	
	public OxidizableSlimeCauldronBlock(Oxidizable.OxidationLevel oxidationLevel, CauldronGroup group, Settings settings) {
