...
public class OxidizableDyedWaterCauldronBlock extends DyedWaterCauldronBlock implements Oxidizable {
	public static final MapCodec<OxidizableDyedWaterCauldronBlock> CODEC = RecordCodecBuilder.mapCodec(
			...
			.apply(instance, OxidizableDyedWaterCauldronBlock::new));
	
	private final Oxidizable.OxidationLevel oxidationLevel;
	
	@Override
	protected MapCodec<OxidizableDyedWaterCauldronBlock> getCodec() {
		return CODEC;
	}
	
	public OxidizableDyedWaterCauldronBlock(Oxidizable.OxidationLevel oxidationLevel, CauldronGroup group, Settings settings) {
