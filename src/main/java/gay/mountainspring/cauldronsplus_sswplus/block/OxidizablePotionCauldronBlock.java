...
public class OxidizablePotionCauldronBlock extends PotionCauldronBlock implements Oxidizable {
	public static final MapCodec<OxidizablePotionCauldronBlock> CODEC = RecordCodecBuilder.mapCodec(
			...
			.apply(instance, OxidizablePotionCauldronBlock::new));
	
	private final Oxidizable.OxidationLevel oxidationLevel;
	
	@Override
	protected MapCodec<OxidizablePotionCauldronBlock> getCodec() {
		return CODEC;
	}
	
	public OxidizablePotionCauldronBlock(Oxidizable.OxidationLevel oxidationLevel, CauldronGroup group, Settings settings) {
